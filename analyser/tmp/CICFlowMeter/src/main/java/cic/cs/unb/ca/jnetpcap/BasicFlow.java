...
public class BasicFlow {
    ...
    public String dumpFlowBasedFeatures(){
    	...
    	dump+=DateFormatter.convertMicroseconds2String(this.flowStartTime, "yyyy-MM-dd HH:mm:ss.SSSSSS")+",";
	...
	public String getTimeStamp() {
		return DateFormatter.convertMicroseconds2String(flowStartTime, "yyyy-MM-dd HH:mm:ss.SSSSSS");
	}
